...
#include "astra/OrderedSubsetSQSAlgorithm.h"
...
std::string COrderedSubsetSQSAlgorithm::type = "OS-SQS";


//---------------------------------------------------------------------------------------
// Clear - Constructors
void COrderedSubsetSQSAlgorithm::_clear()
{
...
//---------------------------------------------------------------------------------------
// Clear - Public
void COrderedSubsetSQSAlgorithm::clear()
{
...
//----------------------------------------------------------------------------------------
// Constructor
COrderedSubsetSQSAlgorithm::COrderedSubsetSQSAlgorithm() 
{
    _clear();
}
...
//---------------------------------------------------------------------------------------
// Initialize - Config
bool COrderedSubsetSQSAlgorithm::initialize(const Config& _cfg)
{
    assert(_cfg.self);
    ConfigStackCheck<CAlgorithm> CC("OS-SQS Algorithm", this, _cfg);
...
//----------------------------------------------------------------------------------------
bool COrderedSubsetSQSAlgorithm::_check()
{
    // check base class
    ASTRA_CONFIG_CHECK(CSartAlgorithm::_check(), "OS-SQS", 
...
//---------------------------------------------------------------------------------------
// Information - All
map<string,boost::any> COrderedSubsetSQSAlgorithm::getInformation() 
{
...
boost::any COrderedSubsetSQSAlgorithm::getInformation(std::string _sIdentifier) 
{
...
//----------------------------------------------------------------------------------------
// Iterate
void COrderedSubsetSQSAlgorithm::run(int _iNrIterations)
{
    // check initialized
