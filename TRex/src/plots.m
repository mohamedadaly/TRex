...
%% Comparison of iterative methods namely ART, SART, SIRT, BICAV, BSSART, OS-SQS
%
...
algs = {
  ...
  struct('name','BSSART', 'type','astra', ...
    ...
    'alg_params', struct('iter',1, ...
      ...
      'Alpha',1, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
      'UseBSSART',1, 'ProjectionOrder',projection_order)))
...
for i=1
  ...
  num_projs = 15; [15, 90]; [15, 30, 60, 90, 180]; [15, 90]; [15, 30, 60, 90, 180]; 
      ...
      for noise_level = noise{1}.noise_levels
        for proj_type = proj_types
          ...
          arg = struct('phan',phantom, 'phan_size',512, 'path','./plots', ...
            ...
            'proj_type',proj_type, 'prefix',prefix, 'plot_resid',0, ...
            'legend_cols',2, 'max_snr',1, 'fig_size',[800 800]);
          % call
          ma_run_and_plot(plt, arg, algs);
        end
      end
...
%% Comparison of WLS weighting functions for different prox operators
...
algs = {
  ...
  struct('name','SART', 'type','astra', ...
    'clr','k', 'lstyle','--', 'marker','d', ...
    'alg','SART', ...
    'alg_params', struct('iter',1, 'wls',0, 'wls_rt',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
      'Alpha',alpha_sart, 'Lambda',lambda, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
      'UseBSSART',0, 'ProjectionOrder',projection_order)))
  
  struct('name','SART-r1', 'type','astra', ...
    'clr','k', 'lstyle','-', 'marker','*', ...
    'alg','SART-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
      'Alpha',alpha_sart, 'Lambda',lambda, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
  ...
  struct('name','SART-r2', 'type','astra', ...
    'clr','k', 'lstyle',':', 'marker','s', ...
    'alg','SART-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',2, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
      'Alpha',alpha_sart, 'Lambda',lambda, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
  ...
  struct('name','SART-r3', 'type','astra', ...
    'clr','k', 'lstyle','-.', 'marker','^', ...
    'alg','SART-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',3, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
      'Alpha',alpha_sart, 'Lambda',lambda, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
  ...
  struct('name','ART', 'type','astra', ...
    'clr','r', 'lstyle','--', 'marker','d', ...
    'alg','ART', ...
    'alg_params', struct('iter',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
      'Alpha',alpha_art, 'Lambda',lambda, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
      'UseBSSART',0, 'ProjectionOrder',projection_order)))

  struct('name','ART-r1', 'type','astra', ...
    'clr','r', 'lstyle','-', 'marker','*', ...
    'alg','ART-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
  ...
  struct('name','BICAV-r1', 'type','astra', ...
    'clr','g', 'lstyle','-', 'marker','*', ...
    'alg','BICAV-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
  ...
  struct('name','BICAV-r2', 'type','astra', ...
  ...
  struct('name','BICAV-r3', 'type','astra', ...
    'clr','g', 'lstyle','-.', 'marker','^', ...
    'alg','BICAV-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',3, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
  ...
  struct('name','OS-SQS', 'type','astra', ...
    'clr','m', 'lstyle','--', 'marker','d', ...
    'alg','OS-SQS', ...
    'alg_params', struct('iter',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
      'Alpha',1, 'Lambda',lambda, 'ComputeIterationMetrics',1, ...
      'ClearReconstruction',1, 'UseJacobiPreconditioner',0, ...
      'UseBSSART',0, 'ProjectionOrder',projection_order)))

  struct('name','OS-SQS-r1', 'type','astra', ...
    'clr','m', 'lstyle','-', 'marker','*', ...
    'alg','OS-SQS-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',1, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
  ...
  struct('name','OS-SQS-r2', 'type','astra', ...
    'clr','m', 'lstyle',':', 'marker','s', ...
    'alg','OS-SQS-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',2, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
      'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
  ...
  struct('name','OS-SQS-r3', 'type','astra', ...
    'clr','m', 'lstyle','-.', 'marker','^', ...
    'alg','OS-SQS-PROX', ...
    'alg_params', struct('iter',1, 'wls',1, 'wls_rt',3, ...
      'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
...
for i=1 %1:2
  ...
  num_projs = nproj; [15, 90]; [15, 30, 60, 90, 180]; [15, 90]; [15, 30, 60, 90, 180]; 
...
%% Comparison of WLS mappings using ADMM
...
for nproj=nprojs
  ...
  algs = {
    ...
    struct('name','SART-r2', 'type','psart', ...
      'clr','k', 'lstyle','--', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_sart, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','SART-PROX', 'wls_rt',2, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_sart, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','SART-r3', 'type','psart', ...
      'clr','k', 'lstyle',':', 'marker','s', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_sart, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','SART-PROX', 'wls_rt',3, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_sart, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','ART-r1', 'type','psart', ...
      'clr','r', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','ART-PROX', 'wls_rt',1, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
            'ClearReconstruction',1, ...
            'UseBSSART',0, 'ProjectionOrder',projection_order))))

    struct('name','ART-r2', 'type','psart', ...
      'clr','r', 'lstyle','--', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','ART-PROX', 'wls_rt',2, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','ART-r3', 'type','psart', ...
      'clr','r', 'lstyle',':', 'marker','s', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','ART-PROX', 'wls_rt',3, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','BICAV-r1', 'type','psart', ...
      'clr','g', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','BICAV-PROX', 'wls_rt',1, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','BICAV-r2', 'type','psart', ...
      'clr','g', 'lstyle','--', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','BICAV-PROX', 'wls_rt',2, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','BICAV-r3', 'type','psart', ...
      'clr','g', 'lstyle',':', 'marker','s', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','BICAV-PROX', 'wls_rt',3, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','OS-SQS-r1', 'type','psart', ...
      'clr','m', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_os, 'mu',mu_os, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','OS-SQS-PROX', 'wls_rt',1, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',1, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','OS-SQS-r2', 'type','psart', ...
      'clr','m', 'lstyle','--', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_os, 'mu',mu_os, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','OS-SQS-PROX', 'wls_rt',2, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',1, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','OS-SQS-r3', 'type','psart', ...
      'clr','m', 'lstyle',':', 'marker','s', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_os, 'mu',mu_os, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','OS-SQS-PROX', 'wls_rt',3, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',1, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
...
algs = {
  ...
  struct('name','Gauss-ITV', 'type','psart', ...
    ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_l2, 'rho',rho_l2, 'mu',mu_l2, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
      'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior','itv', ...
      'sigma_with_data', sigma_with_data, 'prox','astra', 'prox_name','SART-PROX', ...
      'prox_params', struct('iter',2, ...
        'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
          'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
          'Alpha',alpha, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
  ...
  struct('name','Gauss-ATV', 'type','psart', ...
    ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_l2, 'rho',rho_l2, 'mu',mu_l2, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
      'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior','atv', ...
      'sigma_with_data', sigma_with_data, 'prox','astra', 'prox_name','SART-PROX', ...
      'prox_params', struct('iter',2, ...
        'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
          'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
  ...
  struct('name','Gauss-SAD', 'type','psart', ...
    ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_l2, 'rho',rho_l2, 'mu',mu_l2, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
      'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior','sad', ...
      'sigma_with_data', sigma_with_data, 'prox','astra', 'prox_name','SART-PROX', ...
      'prox_params', struct('iter',2, ...
        'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
          'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
  ...
  struct('name','Poiss-ITV', 'type','psart', ...
    'clr','b', 'lstyle',':', 'marker','p', ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_wls, 'rho',rho_wls, 'mu',mu_wls, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
      'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior','itv', ...
      'sigma_with_data', sigma_with_data, 'prox','astra', 'prox_name','SART-PROX', ...
      'prox_params', struct('iter',2, ...
        'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
          'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
  ...
  struct('name','Poiss-ATV', 'type','psart', ...
    ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_wls, 'rho',rho_wls, 'mu',mu_wls, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
      'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior','atv', ...
      'sigma_with_data', sigma_with_data, 'prox','astra', 'prox_name','SART-PROX', ...
      'prox_params', struct('iter',2, ...
        'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
          'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
  ...
  struct('name','Poiss-SAD', 'type','psart', ...
    ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_wls, 'rho',rho_wls, 'mu',mu_wls, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
      'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior','sad', ...
      'sigma_with_data', sigma_with_data, 'prox','astra', 'prox_name','SART-PROX', ...
      'prox_params', struct('iter',2, ...
        'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
          'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
  ...
  % IRT types
  %
  struct('name','OS-SQS-Mom-Gauss', 'type','irt', ...
  ...
  struct('name','OS-SQS-Mom-Poiss', 'type','irt', ...
    'clr',[0.5 0.5 0.5], 'lstyle','--', 'marker','<', ...
    'alg','sqs-os-mom', ...
    'alg_params', struct('iter',1, 'beta',1e0, 'pot_arg',{{'gf1', 10, [.0558, 1.6395]}}, ...
      'mom',2, 'relax',[1 0], 'nsubsets',10, 'reg',1, 'wls',1, ...
      'init_fbp',0, 'pixmax',[0, Inf], 'bit_reverse',1))
...
for i=1:2
  if i==1
    ...
    phantoms = {'ncat', 'mod-sl'}; %, 'mod-sl'}; {'ncat', 'mod-sl'}; {'ncat', 'mod-sl'}; {'mod-sl', 'ncat'}; {'ncat', 'mod-sl'}; {'mouse'}; {'ncat', 'mod-sl'};
    noises = {struct('noise_type', 'poisson', 'noise_levels',[1e5])};
    proj_types = {'fan'}; %{'fan', 'parallel', 'mouse'};
  end
      ...
      for noise = noises
        ...
        for noise_level = noise{1}.noise_levels
          for proj_type = proj_types
            ...
            % call
            ma_run_and_plot(plt, arg, algs([1:7]));
          end
        end
      end
    end
...
%% Comparison of proximal operators with ADMM
...
for nproj=nprojs
  ...
  switch nproj
    ...
    case 30
      sigma = .1; .05; .5; .5; .1;
      rho_sart = 100; 50; 200;
      rho_art = 100; 200; 50; 10; 50; 25;  4e3; 1.25e4; 50; 200; 50;
      rho_os = 100; 0.416; 50; 1e-4; .00010; 1;
      mu = []; 
      mu_os = .1;
      alpha_sart = 1; 
      alpha_art = 1;
  ...
  algs = {
    ...
    % PSART types
    %
    struct('name','SART-Gauss', 'type','psart', ...
      'clr','k', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_sart, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','SART-PROX', 'wls_rt',wls_rt_sart, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_sart, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','SART-Poiss', 'type','psart', ...
      'clr','k', 'lstyle',':', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_sart, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
    ...
    struct('name','ART-Gauss', 'type','psart', ...
      'clr','r', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','ART-PROX', 'wls_rt',wls_rt, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','ART-Poiss', 'type','psart', ...
      'clr','r', 'lstyle',':', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
    ...
    struct('name','BICAV-Gauss', 'type','psart', ...
      'clr','g', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','BICAV-PROX', 'wls_rt',wls_rt, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',alpha_art, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','BICAV-Poiss', 'type','psart', ...
      'clr','g', 'lstyle',':', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_art, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
    ...
    struct('name','OS-SQS-Gauss', 'type','psart', ...
      'clr','m', 'lstyle','-', 'marker','d', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_os, 'mu',mu_os, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','l2', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','OS-SQS-PROX', 'wls_rt',wls_rt, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',1, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
    ...
    struct('name','OS-SQS-Poiss', 'type','psart', ...
      'clr','m', 'lstyle',':', 'marker','*', ...
      'alg','admm', ...
      'alg_params', struct('iter',1, 'sigma',sigma, 'rho',rho_os, 'mu',mu_os, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
        'theta',1, 'init_fbp',init_fbp, 'data','wls', 'prior',prior, ...
        'sigma_with_data', sigma_with_data, 'prox','astra', ...
        'prox_name','OS-SQS-PROX', 'wls_rt',wls_rt_os, ...
        'prox_params', struct('iter',2, ...
          'option',struct('UseMinConstraint',1, 'MinConstraintValue',0, ...
            'UseMaxConstraint',0, 'MaxConstraintValue',1, ...
            'Alpha',1, 'Lambda',1e3, 'ComputeIterationMetrics',1, ...
...
%       lambda_mfista = 0.001;
%       mEAWA_mfista = []; 50e3;4e3; 1e6; % max eigenvalue of AWA
%       init_fbp_ramani = 0;
%       wls_ramani = 1;
    case 30
      sigma = .1; .05; .1;
...
%       'init_fbp',0, 'pixmax',[0, Inf], 'bit_reverse',1))
    ...
    struct('name','Kim-OS', 'type','irt', ...
      'clr','g', 'lstyle','-', 'marker','o', ...
      'alg','sqs-os', ...
      'alg_params', struct('iter',1, 'beta',beta_kim, ...
        'pot_arg',{{'gf1', 10, [.0558, 1.6395]}}, ...
        'mom',0, 'relax',relax_kim, 'nsubsets',nsubsets_kim, 'reg',1, 'wls',1, ...
        'init_fbp',0, 'pixmax',[0, Inf], 'bit_reverse',1))                  
...
%         'prior_type',prior_ramani, 'operator',operator_ramani, ...
%         'init_fbp',init_fbp_ramani, 'precon',1, 'minx',0, ...
%         'wls',wls_ramani, 'use_kappa',use_kappa_ramani, ...
%         'mEAWA',mEAWA_mfista))
