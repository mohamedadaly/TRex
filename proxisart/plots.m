          ...
          for noise_level = noise{1}.noise_levels
            for proj_type = proj_types
              ...
              arg = struct('phan',phantom, 'phan_size',512, 'path','./plots', ...
                ...
                'save',1);
              % call
              ma_run_and_plot(plt, arg, algs([1  10 11 12]));
            end
          end
        end
      end
...
switch nproj
  ...
  case 30
    sigma = .1; .05; .5; .5; .1;
    rho_sart = 50; 50; 200;
    rho_art = 50; 200; 50; 10; 50; 25;  4e3; 1.25e4; 50; 200; 50;
    rho_os = 0.416; 50; 1e-4; .00010; 1;
    mu = []; 
    alpha_sart = 1; .1; 1.99; 1;
    alpha_art = 1;
    sigma_with_data = 0;
    wls_rt_sart = 1;
    wls_rt = 3;
        ...
        for noise_level = noise{1}.noise_levels
          for proj_type = proj_types
            ...
            arg = struct('phan',phantom, 'phan_size',512, 'path','./plots', ...
              ...
              'save',1);
            % call
            ma_run_and_plot(plt, arg, algs([1: 8]));
          end
        end
      end
    end
