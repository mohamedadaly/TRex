...
% sigma_with_data
% s=10,1&r=.1,1 good for wls
sigma_l2 = 1; %25
rho_l2 = 10; %100 good for SAD
sigma_wls = 1;
rho_wls = 1;
mu = []; 1e-3;
alpha = 2;
...
algs = {
  ...
  struct('name','Gauss-ITV', 'type','psart', ...
    ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_l2, 'rho',rho_l2, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
  ...
  struct('name','Poiss-ITV', 'type','psart', ...
    'clr','b', 'lstyle',':', 'marker','p', ...
    'alg','admm', ...
    'alg_params', struct('iter',1, 'sigma',sigma_wls, 'rho',rho_wls, 'mu',mu, ...1/(8*rho), ... 40&3 (no fbp) 100&5 (fbp)
  ...
  % IRT types
  %
  struct('name','OS-SQS-Mom', 'type','irt', ...
    'clr',[0.5 0.5 0.5], 'lstyle','-', 'marker','<', ...
    'alg','sqs-os-mom', ...
    'alg_params', struct('iter',1, 'beta',100, 'pot_arg',{{'gf1', 10, [.0558, 1.6395]}}, ...
      'mom',2, 'relax',[1 1e-5], 'nsubsets',10, 'reg',1, 'wls',1, ...
