...
#ifndef _INC_ASTRA_BICAVALGORITHM
#define _INC_ASTRA_BICAVALGORITHM
...
public:
	 ...
	 */
	CBicavAlgorithm(CProjector2D* _pProjector, 
...
// inline functions
inline std::string CBicavAlgorithm::description() const { return CBicavAlgorithm::type; };
