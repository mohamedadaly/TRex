...
#ifndef _INC_ASTRA_ORDEREDSUBSETSQSALGORITHM
#define _INC_ASTRA_ORDEREDSUBSETSQSALGORITHM
...
/**
 * \brief
 * This class contains the implementation of the Ordered Subset Separable Quadratic Surrogate (OS-SQS)
 * algorithm. The limition now is that it's like SART, where #subsets = #views/projections.
 *
 ...
 */
class _AstraExport COrderedSubsetSQSAlgorithm : public CSartAlgorithm {
...
public:
    ...
    /** Destructor. 
     */
    virtual ~COrderedSubsetSQSAlgorithm();
...
// inline functions
inline std::string COrderedSubsetSQSAlgorithm::description() const { return COrderedSubsetSQSAlgorithm::type; };
