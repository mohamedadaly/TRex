...
#ifndef _INC_ASTRA_ARTPROXOPERATORALGORITHM
#define _INC_ASTRA_ARTPROXOPERATORALGORITHM
...
/**
 * \brief
 * This class contains the implementation of the ART proximal operator.
 *
 ...
 * }
 */
class _AstraExport CArtProxOperatorAlgorithm : public CArtAlgorithm {
...
public:
     ...
     */
    CArtProxOperatorAlgorithm(CProjector2D* _pProjector, 
    ...
    /** Destructor.
     */
    virtual ~CArtProxOperatorAlgorithm();
...
// inline functions
inline std::string CArtProxOperatorAlgorithm::description() const { return CArtProxOperatorAlgorithm::type; };
