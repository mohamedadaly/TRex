...
#ifndef _INC_ASTRA_ORDEREDSUBSETSQSPROXOPERATORALGORITHM
#define _INC_ASTRA_ORDEREDSUBSETSQSPROXOPERATORALGORITHM
...
/**
 * \brief
 * This class contains the implementation of the proximal operator using the OS-SQS formulation.
 *
...
public:
     ...
     */
    COrderedSubsetSQSProxOperatorAlgorithm(CProjector2D* _pProjector, 
    ...
    /** Destructor.
     */
    virtual ~COrderedSubsetSQSProxOperatorAlgorithm();
...
// inline functions
inline std::string COrderedSubsetSQSProxOperatorAlgorithm::description() const { return COrderedSubsetSQSProxOperatorAlgorithm::type; };
