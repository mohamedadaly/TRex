...
#ifndef _INC_ASTRA_ARTBASEALGORITHM
#define _INC_ASTRA_ARTBASEALGORITHM
 ...
 * }
 */
class _AstraExport CArtBaseAlgorithm : public CReconstructionAlgorithm2D {
...
public:
	 ...
	 */
	CArtBaseAlgorithm(CProjector2D* _pProjector, 
	...
	virtual bool initialize(CProjector2D* _pProjector, 
							CFloat32ProjectionData2D* _pSinogram, 
							CFloat32VolumeData2D* _pReconstruction) = 0;

	/** Get all information parameters
	 *
	 * @return map with all boost::any object
	 */
	virtual map<string,boost::any> getInformation() = 0;
	 ...
	 */
	virtual boost::any getInformation(std::string _sIdentifier) = 0;
	 ...
	 */
	virtual void run(int _iNrIterations = 1) = 0;
...
// inline functions
inline std::string CArtBaseAlgorithm::description() const { return "ArtBase"; };
