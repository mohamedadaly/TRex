...
#ifndef _INC_ASTRA_BICAVPROXOPERATORALGORITHM
#define _INC_ASTRA_BICAVPROXOPERATORALGORITHM
...
/**
 * \brief
 * This class contains the implementation of the BICAV proximal operator.
 *
 ...
 * }
 */
class _AstraExport CBicavProxOperatorAlgorithm : public CSartProxOperatorAlgorithm {
...
public:
     ...
     */
    CBicavProxOperatorAlgorithm(CProjector2D* _pProjector, 
    ...
    /** Destructor.
     */
    virtual ~CBicavProxOperatorAlgorithm();
...
// inline functions
inline std::string CBicavProxOperatorAlgorithm::description() const { return CBicavProxOperatorAlgorithm::type; };
