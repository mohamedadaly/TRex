...
/**
 * \brief
 * This class contains the implementation of the Proximal SART (Simultaneous Algebraic Reconstruction Technique) algorithm.
 *
 ...
 * }
 */
class _AstraExport CPSartAlgorithm : public CReconstructionAlgorithm2D {
