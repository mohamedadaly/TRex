...
#ifndef _INC_ASTRA_BLOCKSIMPLIFIEDSARTALGORITHM
#define _INC_ASTRA_BLOCKSIMPLIFIEDSARTALGORITHM
...
/**
 * \brief
 * This class contains the implementation of the Block Simplified SART algorithm, which is a simplification 
 * of SART that basically uses the column sums for all rows, instead of only in the current view/projection.
 *
 ...
 */
class _AstraExport CBlockSimplifiedSartAlgorithm : public CSartAlgorithm {
...
public:
     ...
     */
    CBlockSimplifiedSartAlgorithm(CProjector2D* _pProjector, 
    ...
    /** Destructor. 
     */
    virtual ~CBlockSimplifiedSartAlgorithm();
...
// inline functions
inline std::string CBlockSimplifiedSartAlgorithm::description() const { return CBlockSimplifiedSartAlgorithm::type; };
